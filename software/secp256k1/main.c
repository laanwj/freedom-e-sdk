...
int main (void){
    ...
    /* find random seed - just keep at zero for now */
    ...
    /* initialize */
#if 0 /* do not run these: lots of dynamic allocation and memory use */
    printf("run_context_tests\n");
    run_context_tests();
#endif
    printf("context_create\n");
    ctx = secp256k1_context_create(SECP256K1_CONTEXT_SIGN | SECP256K1_CONTEXT_VERIFY);
    printf("context_randomize\n");
    if (secp256k1_rand_bits(1)) {
        secp256k1_rand256(run32);
        CHECK(secp256k1_context_randomize(ctx, secp256k1_rand_bits(1) ? run32 : NULL));
    }

    printf("run_rand_bits\n");
    run_rand_bits();
    printf("run_rand_int\n");
    run_rand_int();
    printf("run_sha256_tests\n");
    run_sha256_tests();
    printf("run_hmac_sha256_tests\n");
    run_hmac_sha256_tests();
    printf("rfc6979_hmac_sha256_tests\n");
    run_rfc6979_hmac_sha256_tests();

    /* scalar tests */
    printf("run_scalar_tests\n");
    run_scalar_tests();

    /* field tests */
    printf("run_field_inv\n");
    run_field_inv();
    printf("run_field_inv_var\n");
    run_field_inv_var();
    printf("run_field_inv_all_var\n");
    run_field_inv_all_var();
    printf("run_field_misc\n");
    run_field_misc();
    printf("run_field_convert\n");
    run_field_convert();
    printf("run_sqr\n");
    run_sqr();
    printf("run_sqrt\n");
    ...
    printf("run_wnaf\n");
    run_wnaf();
    printf("run_point_times_order\n");
    run_point_times_order();
    printf("run_ecmult_chain\n");
    run_ecmult_chain();
    printf("run_ecmult_constants\n");
    run_ecmult_constants();
    printf("run_ecmult_gen_blind\n");
    run_ecmult_gen_blind();
    printf("run_ecmult_const_tests\n");
    run_ecmult_const_tests();
    printf("run_ec_combine\n");
    run_ec_combine();
    ...
    printf("run_ec_pubkey_parse_test\n");
    run_ec_pubkey_parse_test();

    /* EC key edge cases */
    printf("run_eckey_edge_case_test\n");
    ...
    /* ecdsa tests */
    printf("run_random_pubkeys\n");
    run_random_pubkeys();
    printf("run_ecdsa_der_parse\n");
    run_ecdsa_der_parse();
    printf("run_ecdsa_sign_verify\n");
    ...
    /* shutdown */
    printf("secp256k1_context_destroy\n");
